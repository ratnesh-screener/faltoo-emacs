...
(defun faltoo-chat--format-hook-feedback (text)
  "Wrap hook feedback TEXT in its transcript separators."
  (string-join (list faltoo-chat--hook-feedback-separator
                     (string-trim text)
